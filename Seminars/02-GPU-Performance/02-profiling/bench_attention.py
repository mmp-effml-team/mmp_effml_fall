...
def train(cfg: TrainConfig):
    ...
    # NOTE: @contextmanager objects are single-use, so build a fresh one every step (see make_sync_ctx below)
    def make_sync_ctx():
        return cuda_sync_detect('error') if cfg.debug_gpu_cpu_sync else nullcontext()
